    ...
    if (!param?.case) {
      ...
      setNewCaseData((pre: any) => ({
        ...
        diagnosisDetails: {
          ...
          // alcoholConsumer: ,
          contractNumber: Number(Contact_number),
        ...
        admissionDetails: {
          HIV_STD_related_ailments_months: anyHIVOrSTDOrRelatedAlimentsMonth,
          HIV_STD_related_ailments_year: anyHIVOrSTDOrRelatedAlimentsYear,
